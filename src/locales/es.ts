export default {
    ...
    player: {
     ...
     settings: {
        ...
        debugTitle: "Ajustes de Depuración",
        ...
        modelsError: "Error al cargar modelos",
    ...
    tts: {
        ...
        voiceCloningUnavailable: "La clonación de voz no está disponible con el backend TTS activo.",
        clone: "Clonar",
        record: "Grabar",
