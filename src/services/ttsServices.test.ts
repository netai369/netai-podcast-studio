...
import { generatePodcastScriptStream, generatePodcastMetadata, fetchAvailableModels, generatePodcastAudio, generateVoicePreviewAudio, fetchAvailableVoices } from './ttsServices';
...
describe('ttsServices', () => {
  ...
  describe('fetchAvailableModels', () => {
    ...
    it('should throw error for missing configuration', async () => {
      await expect(
        fetchAvailableModels({} as BackendConfig)
      ).rejects.toThrow('Backend configuration is required');
    });
